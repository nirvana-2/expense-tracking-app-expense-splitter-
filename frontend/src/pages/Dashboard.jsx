...
const Dashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-900 text-white selection:bg-indigo-500/30">
            {/* Header */}
            <header className="fixed top-0 w-full z-40 bg-slate-900/80 backdrop-blur-xl border-b border-white/5">
            ...
            <main className="container mx-auto px-4 pt-24 pb-12">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20 border border-dashed border-white/10 rounded-2xl bg-white/5/50">
                        ...
                        <p className="text-slate-400 max-w-md mx-auto mb-6">Create a group to start splitting expenses with your friends, roommates, or trip buddies.</p>
                        <button
                            onClick={() => setShowCreateModal(true)}
                        ...
                        {groups.map(group => {
                            ...
                            return (
                                <div
                                    ...
                                    className="group relative glass-card p-6 rounded-2xl hover:bg-white/5 transition-all cursor-pointer hover:-translate-y-1 hover:shadow-xl hover:shadow-indigo-500/10"
                                >
                                    <div className="absolute top-4 right-4 flex gap-2">
                                        ...
                                        {isAdmin && (
                                            <button
                                                ...
                                                className="text-slate-500 hover:text-rose-400 transition-colors z-10"
                                                title="Delete Group"
                                            >
                                    ...
                                    <h3 className="text-xl font-bold mb-2 truncate pr-16">{group.name}</h3>
