...
const Sidebar = () => {
    ...
    return (
        <div className="h-screen sticky top-0 flex flex-col bg-slate-900 border-r border-white/5">
            <div className="p-6 border-b border-white/5">
                <div className="flex items-center gap-2 mb-8">
                    <div className="w-8 h-8 rounded-lg bg-indigo-600 flex items-center justify-center text-white">
                        <PiggyBank size={20} />
                    </div>
                    <span className="font-bold text-lg tracking-tight text-white">ExpenseSplitter</span>
                </div>

                <button
                    onClick={() => navigate('/')}
                    className="w-full flex items-center gap-2 px-3 py-2 text-slate-400 hover:text-white hover:bg-white/5 rounded-lg transition-colors"
                >
                    <ArrowLeft size={16} />
            ...
            <div className="p-6 border-t border-white/5">
                <div className="text-xs font-semibold text-slate-600 uppercase tracking-widest text-center">
                    v2.0 Rebuild
                </div>
            </div>
        </div>
